...
public class LevelSevenActivity extends AppCompatActivity {
    ...
    Button Valid, Red, Blue, Yellow, Green, Purple, Orange, Cyan, Brown, Teal, Pink;
    ...
    int nbbtn = 10;//initialisation du nombre de bouton (pour les random)
    ...
    protected void onCreate(Bundle savedInstanceState) { //fonction éxecuter au lancement de l'activité
        ...
        Pink = findViewById(R.id.btn_pink_id);
        ...
        couleur[9] = R.color.pink_dark;
        couleur[10] = R.color.red_light;
        couleur[11] = R.color.blue_light;
        couleur[12] = R.color.yellow_light;
        couleur[13] = R.color.green_light;
        couleur[14] = R.color.purple_light;
        couleur[15] = R.color.orange_light;
        couleur[16] = R.color.cyan_light;
        couleur[17] = R.color.brown_light;
        couleur[18] = R.color.teal_light;
        couleur[19] = R.color.pink_light;
    ...
    public void btnOnClick(View view) {//fonction qui s'exxecute lorsque l'on clique sur l'un des boutons de couleurs
        ...
        if (btnToTest < height) {//si le bouton à tester est inférieur au bouton à allumer
            switch (view.getId()) {//pour chaque cas d'appuie sur un bouton
                ...
                case R.id.btn_pink_id: {
                    if (btnTable[btnToTest] != Pink) {
                        loose[0] = true;
                    }
                    break;
                }
