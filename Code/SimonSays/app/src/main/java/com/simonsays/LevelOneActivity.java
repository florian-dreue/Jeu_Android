...
public class LevelOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) { //fonction éxecuter au lancement de l'activité
        ...
        couleur[4]=R.color.red_light;
        couleur[5]=R.color.blue_light;
        couleur[6]=R.color.yellow_light;
        couleur[7]=R.color.green_light;
