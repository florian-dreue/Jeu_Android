...
public class LevelTwoActivity extends AppCompatActivity {
    ...
    Button Valid, Red, Blue, Yellow, Green, Purple;
    ...
    int nbbtn = 5;//initialisation du nombre de bouton (pour les random)
    ...
    protected void onCreate(Bundle savedInstanceState) { //fonction éxecuter au lancement de l'activité
        ...
        couleur[5]=R.color.red_light;
        couleur[6]=R.color.blue_light;
        couleur[7]=R.color.yellow_light;
        couleur[8]=R.color.green_light;
        couleur[9]=R.color.purple_light;
