...
public class LevelFourActivity extends AppCompatActivity {
    ...
    Button Valid, Red, Blue, Yellow, Green, Purple, Orange, Cyan;
    ...
    int nbbtn = 7;//initialisation du nombre de bouton (pour les random)
    ...
    protected void onCreate(Bundle savedInstanceState) { //fonction éxecuter au lancement de l'activité
        ...
        couleur[7] = R.color.red_light;
        couleur[8] = R.color.blue_light;
        couleur[9] = R.color.yellow_light;
        couleur[10] = R.color.green_light;
        couleur[11] = R.color.purple_light;
        couleur[12] = R.color.orange_light;
        couleur[13] = R.color.cyan_light;
        ...
        if (loose[0]) {//si on as appuyer sur une mauvaise couleur
            ...
            if (btnToTest + 1 == height) {//si la couleur tester +1 est égale au nombre de bouton allumer
                if (btnToTest + 1 == nbbtnmax) {//si la couleur tester est égale au nombre maximum de bouton allumer
                    ...
                    Intent intent = new Intent(LevelFourActivity.this, LevelFiveActivity.class);
