...
public class LevelThreeActivity extends AppCompatActivity {
    ...
    Button Valid, Red, Blue, Yellow, Green, Purple, Orange;
    ...
    int nbbtn = 6;//initialisation du nombre de bouton (pour les random)
    ...
    protected void onCreate(Bundle savedInstanceState) { //fonction éxecuter au lancement de l'activité
        ...
        couleur[6]=R.color.red_light;
        couleur[7]=R.color.blue_light;
        couleur[8]=R.color.yellow_light;
        couleur[9]=R.color.green_light;
        couleur[10]=R.color.purple_light;
        couleur[11]=R.color.orange_light;
